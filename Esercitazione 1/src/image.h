...
struct Image
  ...
  int w=0; //Width
  int h=0; //Height
  int c=0; //n of Channels
  float* data=nullptr; //Dati dell'immagine, che sarà fondamentalmente una matrice
  
  // constructor
  Image() = default;

  //Se non inserisco c alla dichiarazione, il numero standard di canali è 1

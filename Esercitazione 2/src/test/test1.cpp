...
void test_hybrid_image() {
    ...
    lfreq_man.save_image("low_man");
    hfreq_w.save_image("high_woman");
    Image gt = load_image("data/hybrid.png");
    reconstruct.clamp();
    reconstruct.save_image("hybrid");
...
void test_frequency_image() {
    ...
    lfreq.save_image("low");
    hfreq.save_image("high");
    reconstruct.save_image("reconstruct");
...
void test_sobel() {
    ...
    save_png(mag, "mag");
    save_png(theta, "theta");

    Image imo = colorize_sobel(im);
    save_png(imo, "color_sobel");
...
int main(int argc, char **argv) {
    ...
    Image im1 = load_image("data/dogsmall.jpg");
    Image res1 = nearest_resize(im1, im1.w*4, im1.h* 4);
    res1.save_image("nn_resize_4");
    
    Image im0 = load_image("data/dog.jpg");
    Image res = nearest_resize(im0, 5, 10);
    res.save_image("nn_resize");
    
    Image im2 = load_image("nn_resize.jpg");
    Image res2 = nearest_resize(im2, 768, 576);
    res2.save_image("nn_resize_stupido");
    
    Image im3 = load_image("data/dogsmall.jpg");
    Image res3 = bilinear_resize(im3, im3.w*4, im3.h*4);
    res3.save_image("linear_resize_prova");
    
    Image im4 = load_image("data/dog.jpg");
    Image f4 = make_highpass_filter();
    Image blur4 = convolve_image(im4, f4, false);
    blur4.clamp();
    //f4.save_image("hp");
    blur4.save_image("hp_filter");
    
    Image im5 = load_image("data/dog.jpg");
    Image f5 = make_emboss_filter();
    Image blur5 = convolve_image(im5, f5, true);
    blur5.clamp();
    //f5.save_image("eb");
    blur5.save_image("eb_filter");
    
    Image im6 = load_image("data/dog.jpg");
    Image f6 = make_sharpen_filter();
    Image blur6 = convolve_image(im6, f6, true);
    blur6.clamp();
    //f6.save_image("sp");
    blur6.save_image("sp_filter");

    Image im7 = load_image("data/dog.jpg");
    Image f7 = make_box_filter(7);
    Image blur7 = convolve_image(im7, f7, false);
    blur7.clamp();
    blur7.save_image("convolution");
